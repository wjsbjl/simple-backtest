...
if __name__ == '__main__':
    ...
    data['sgnl'] = pd.read_csv('./data/demo_data_of_bkt_main.csv')['sgnl']#['sgnl']
    data_score = pos2value(data,data,stop_loss = 0.96, stop_gain = 1.5)
    # data_score.to_csv('./bkt_rslt/trade.csv') # 1.418033471	1.410876263
